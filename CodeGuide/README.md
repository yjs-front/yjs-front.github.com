...
### 2. 如何使用？ 
在使用之前花一点时间把[规范](http://yyfax.github.io/CodeGuide/)看一遍是很必要的，  
然后按照[这里](http://yyfax.github.io/CodeGuide/#check)的步骤配置好编辑器和构建检查（目前仅提供了sublime3和grunt的配置）
...
![](http://yyfax.github.io/CodeGuide/images/demo_1.png)

将光标移到该行，可以在状态栏中看到详细的错误信息：
![](http://yyfax.github.io/CodeGuide/images/demo_2.png)
